...
\begingroup
\thispagestyle{empty}
\AddToShipoutPicture*{\put(-20,-20){\includegraphics[scale=4.8]{./res/crushed/mouse-and-elephant-fs8.png}}} % Image background
\centering
\vspace*{5cm}
\endgroup

\bidicontourlength{1.5pt}
\bidicontour{white}{\sffamily\fontsize{15}{15}\selectfont Elevate the Elephant} \par



\bidicontour{white}{\sffamily\fontsize{42}{42}\selectfont 撬动大象}\par
...
\begin{center}
{\scshape\large Elevate the Elephant \par}
\vspace{10pt}
{\scshape\Huge 撬动大象\par}
\vspace{2cm}
